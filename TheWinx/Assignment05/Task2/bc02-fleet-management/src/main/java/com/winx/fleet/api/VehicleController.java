...
public class VehicleController {
    ...
    @GetMapping
    public ResponseEntity<List<VehicleResponse>> byProvider(@RequestParam(required = false) Long providerId) {
        List<Vehicle> vehicles = providerId != null
                ? fleetStatusService.getFleetOverview(providerId)
